...
mkdir -p libmp/arm64/debug/mediapipe
...
cp -r bazel-bin/mediapipe/modules libmp/arm64/debug/mediapipe/modules
...
mkdir -p libmp/arm64/release/mediapipe
...
cp -r bazel-bin/mediapipe/modules libmp/arm64/release/mediapipe/modules
...
mkdir -p libmp/x86_64/debug/mediapipe
...
cp -r bazel-bin/mediapipe/modules libmp/x86_64/debug/mediapipe/modules
...
mkdir -p libmp/x86_64/release/mediapipe
...
cp -r bazel-bin/mediapipe/modules libmp/x86_64/release/mediapipe/modules
